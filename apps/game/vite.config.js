...
import { compileProject } from '@neon-divide/content';

// Fail development startup and production builds before Phaser sees invalid
// canonical content. This has no runtime cost in the browser bundle.
compileProject();
